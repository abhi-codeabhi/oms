// Command server is the composition root for the catalog service. It wires adapters
...
import (
	...
	grpcadapter "github.com/restorna/platform/services/catalog/internal/adapters/grpc"
	pgadapter "github.com/restorna/platform/services/catalog/internal/adapters/pg"
	"github.com/restorna/platform/services/catalog/internal/app"
	"github.com/restorna/platform/services/catalog/migrations"
)
...
func main() {
	...
	log.Info().Str("port", cfg.Port).Msg("catalog service starting")
